...
<head>
  ...
  <style>
    ...
    .lmodal-overlay.active { opacity: 1; pointer-events: all; }
    ...
    .lmodal-overlay.active .lmodal { transform: translateY(0) scale(1); }
    ...
    .lmodal__banner--blue   { background: linear-gradient(135deg, #1a3a6e 0%, #2d5fa6 100%); }
    .lmodal__banner--green  { background: linear-gradient(135deg, #1a5c3a 0%, #28855a 100%); }
    .lmodal__banner--purple { background: linear-gradient(135deg, #4a1c6e 0%, #7c3aed 100%); }
    .lmodal__banner--amber  { background: linear-gradient(135deg, #7c3a00 0%, #c47a1e 100%); }
    .lmodal__banner--teal   { background: linear-gradient(135deg, #0d4a4a 0%, #0d9488 100%); }
    .lmodal__banner--navy   { background: linear-gradient(135deg, #0f1b35 0%, #243b6e 100%); }
    ...
    .lmodal__close:hover { background: rgba(255,255,255,.28); }
    ...
    /* Verified badge */
    .lmodal__verified {
      position: absolute; bottom: -30px; left: 74px; z-index: 3;
    ...
    /* Body */
    .lmodal__body { padding: 44px 28px 24px; }
    ...
    .lmodal__spec { font-size: .88rem; color: var(--text-muted); margin-bottom: 12px; }
    ...
    .lmodal__stars { color: var(--accent-gold); font-size: .95rem; letter-spacing: 1px; }
    .lmodal__rating-val { font-size: .88rem; font-weight: 700; color: var(--text-primary); }
    .lmodal__rating-count { font-size: .8rem; color: var(--text-muted); }

    .lmodal__tags { display: flex; gap: 7px; flex-wrap: wrap; margin-bottom: 18px; }
    .lmodal__tag {
    ...
    .lmodal__info-item i { color: var(--text-muted); font-size: .85rem; flex-shrink: 0; }
    .lmodal__info-text { display: flex; flex-direction: column; }
    .lmodal__info-label { font-size: .68rem; color: var(--text-muted); text-transform: uppercase; letter-spacing: .05em; }
    .lmodal__info-val   { font-size: .85rem; font-weight: 600; color: var(--text-primary); }
    ...
    .lmodal__price-label { font-size: .8rem; color: var(--text-muted); }
    .lmodal__price-val   { font-size: 1.3rem; font-weight: 700; color: var(--navy-900); }
    .lmodal__price-note  { font-size: .75rem; color: var(--text-muted); }
    ...
    @media (max-width: 580px) {
      .lmodal__info-grid { grid-template-columns: 1fr; }
      .lmodal__slots { grid-template-columns: repeat(2,1fr); }
      .lmodal__body { padding: 44px 20px 20px; }
      .lmodal__footer { padding: 14px 20px 20px; flex-direction: column; }
    }
  </style>
</head>
<body>
  ...
  <aside class="sidebar" id="sidebar">
    ...
    <nav class="sidebar__nav">
      ...
      <ul class="sidebar__menu">
        ...
        <li class="sidebar__menu-item"><a href="assistente.html" class="sidebar__menu-link"><span class="sidebar__menu-icon"><i class="fa-solid fa-robot"></i></span><span class="sidebar__menu-text">Assistente IA</span></a></li>
        <li class="sidebar__menu-item sidebar__menu-item--active"><a href="consultas.html" class="sidebar__menu-link"><span class="sidebar__menu-icon"><i class="fa-solid fa-calendar-check"></i></span><span class="sidebar__menu-text">Consultas</span></a></li>
    ...
    <header class="topbar">
      <div class="topbar__left">
        ...
        <div class="topbar__breadcrumb">
          <h1 class="topbar__title">Consultas</h1>
          <p class="topbar__subtitle">Advogados qualificados prontos para o ajudar</p>
        </div>
      </div>
      <div class="topbar__right">
        <div class="search-bar">
          <i class="fa-solid fa-magnifying-glass" style="color:var(--text-muted);font-size:.85rem"></i>
          <input type="text" placeholder="Pesquisar advogados..." class="search-bar__input" />
        </div>
        <div class="user-btn">
    ...
    <section class="section">
      ...
      <div class="lawyers-grid">
        ...
        <div class="lawyer-card">
          <div class="lawyer-card__banner lawyer-card__banner--blue"><div class="lawyer-card__avatar">MS</div></div>
          <div class="lawyer-card__body">
            ...
            <div class="lawyer-card__rating"><div class="stars">★★★★★</div><span class="lawyer-card__rating-value">4.9</span><span class="lawyer-card__rating-count">(127 avaliações)</span></div>
        ...
        <div class="lawyer-card">
          <div class="lawyer-card__banner lawyer-card__banner--green"><div class="lawyer-card__avatar">RP</div></div>
          <div class="lawyer-card__body">
            <div class="lawyer-card__name">Dr. Ricardo Pinto</div>
            <div class="lawyer-card__spec">Direito do Trabalho · Laboral</div>
            <div class="lawyer-card__rating"><div class="stars">★★★★★</div><span class="lawyer-card__rating-value">4.8</span><span class="lawyer-card__rating-count">(89 avaliações)</span></div>
            <div class="lawyer-card__details">
        ...
        <div class="lawyer-card">
          <div class="lawyer-card__banner lawyer-card__banner--purple"><div class="lawyer-card__avatar">AC</div></div>
          <div class="lawyer-card__body">
            <div class="lawyer-card__name">Dra. Ana Costa</div>
            <div class="lawyer-card__spec">Direito Fiscal · Tributário</div>
            <div class="lawyer-card__rating"><div class="stars">★★★★★</div><span class="lawyer-card__rating-value">5.0</span><span class="lawyer-card__rating-count">(203 avaliações)</span></div>
            <div class="lawyer-card__details">
              <div class="lawyer-card__detail"><i class="fa-solid fa-location-dot"></i> Lisboa, Portugal</div>
        ...
        <div class="lawyer-card">
          <div class="lawyer-card__banner lawyer-card__banner--amber"><div class="lawyer-card__avatar">JF</div></div>
          <div class="lawyer-card__body">
            <div class="lawyer-card__name">Dr. Jorge Ferreira</div>
            <div class="lawyer-card__spec">Direito Imobiliário · Arrendamento</div>
            <div class="lawyer-card__rating"><div class="stars">★★★★☆</div><span class="lawyer-card__rating-value">4.6</span><span class="lawyer-card__rating-count">(54 avaliações)</span></div>
            <div class="lawyer-card__details">
        ...
        <div class="lawyer-card">
          <div class="lawyer-card__banner lawyer-card__banner--teal"><div class="lawyer-card__avatar">CM</div></div>
          <div class="lawyer-card__body">
            <div class="lawyer-card__name">Dra. Catarina Moura</div>
            <div class="lawyer-card__spec">Direito Empresarial · Sociedades</div>
            <div class="lawyer-card__rating"><div class="stars">★★★★★</div><span class="lawyer-card__rating-value">4.9</span><span class="lawyer-card__rating-count">(176 avaliações)</span></div>
            <div class="lawyer-card__details">
        ...
        <div class="lawyer-card">
          <div class="lawyer-card__banner lawyer-card__banner--navy"><div class="lawyer-card__avatar">LR</div></div>
          <div class="lawyer-card__body">
            <div class="lawyer-card__name">Dr. Luís Rodrigues</div>
            <div class="lawyer-card__spec">Direito de Família · Herança</div>
            <div class="lawyer-card__rating"><div class="stars">★★★★☆</div><span class="lawyer-card__rating-value">4.7</span><span class="lawyer-card__rating-count">(91 avaliações)</span></div>
            <div class="lawyer-card__details">
    ...
    <div class="lmodal">
      ...
      <div class="lmodal__body">
        ...
        <div class="lmodal__info-grid">
          <div class="lmodal__info-item"><i class="fa-solid fa-location-dot"></i><div class="lmodal__info-text"><span class="lmodal__info-label">Localização</span><span class="lmodal__info-val">Lisboa, Portugal</span></div></div>
          <div class="lmodal__info-item"><i class="fa-solid fa-graduation-cap"></i><div class="lmodal__info-text"><span class="lmodal__info-label">Experiência</span><span class="lmodal__info-val">12 anos</span></div></div>
          <div class="lmodal__info-item"><i class="fa-solid fa-university"></i><div class="lmodal__info-text"><span class="lmodal__info-label">Formação</span><span class="lmodal__info-val">FD — Univ. Lisboa</span></div></div>
          <div class="lmodal__info-item"><i class="fa-solid fa-video"></i><div class="lmodal__info-text"><span class="lmodal__info-label">Modalidade</span><span class="lmodal__info-val">Online e Presencial</span></div></div>
        </div>
        ...
        <div class="lmodal__price-strip">
          <div><div class="lmodal__price-label">Valor da consulta</div><div class="lmodal__price-val">80€ <small style="font-size:.75rem;font-weight:400;color:var(--text-muted)">/hora</small></div></div>
          <div style="text-align:right"><div class="lmodal__price-note">Primeira consulta</div><div style="font-size:.88rem;font-weight:700;color:var(--green-600,#16a34a)">40€ (50% desconto)</div></div>
        </div>
  ...
  <div class="lmodal-overlay" id="m2">
    <div class="lmodal">
      ...
      <div class="lmodal__body">
        ...
        <div class="lmodal__info-grid">
          <div class="lmodal__info-item"><i class="fa-solid fa-location-dot"></i><div class="lmodal__info-text"><span class="lmodal__info-label">Localização</span><span class="lmodal__info-val">Porto, Portugal</span></div></div>
          <div class="lmodal__info-item"><i class="fa-solid fa-graduation-cap"></i><div class="lmodal__info-text"><span class="lmodal__info-label">Experiência</span><span class="lmodal__info-val">8 anos</span></div></div>
          <div class="lmodal__info-item"><i class="fa-solid fa-chalkboard-teacher"></i><div class="lmodal__info-text"><span class="lmodal__info-label">Actividade extra</span><span class="lmodal__info-val">Docente universitário</span></div></div>
          <div class="lmodal__info-item"><i class="fa-solid fa-video"></i><div class="lmodal__info-text"><span class="lmodal__info-label">Modalidade</span><span class="lmodal__info-val">Online e Presencial</span></div></div>
        </div>
        ...
        <div class="lmodal__price-strip">
          <div><div class="lmodal__price-label">Valor da consulta</div><div class="lmodal__price-val">70€ <small style="font-size:.75rem;font-weight:400;color:var(--text-muted)">/hora</small></div></div>
          <div style="text-align:right"><div class="lmodal__price-note">Primeira consulta</div><div style="font-size:.88rem;font-weight:700;color:var(--green-600,#16a34a)">35€ (50% desconto)</div></div>
        </div>
  ...
  <div class="lmodal-overlay" id="m3">
    <div class="lmodal">
      ...
      <div class="lmodal__body">
        ...
        <div class="lmodal__info-grid">
          <div class="lmodal__info-item"><i class="fa-solid fa-location-dot"></i><div class="lmodal__info-text"><span class="lmodal__info-label">Localização</span><span class="lmodal__info-val">Lisboa, Portugal</span></div></div>
          <div class="lmodal__info-item"><i class="fa-solid fa-graduation-cap"></i><div class="lmodal__info-text"><span class="lmodal__info-label">Experiência</span><span class="lmodal__info-val">15 anos</span></div></div>
          <div class="lmodal__info-item"><i class="fa-solid fa-trophy"></i><div class="lmodal__info-text"><span class="lmodal__info-label">Avaliação</span><span class="lmodal__info-val">5.0 / 5.0 perfeita</span></div></div>
          <div class="lmodal__info-item"><i class="fa-solid fa-video"></i><div class="lmodal__info-text"><span class="lmodal__info-label">Modalidade</span><span class="lmodal__info-val">Online e Presencial</span></div></div>
        </div>
        <div class="lmodal__section-title">Sobre a advogada</div>
        ...
        <div class="lmodal__price-strip">
          <div><div class="lmodal__price-label">Valor da consulta</div><div class="lmodal__price-val">120€ <small style="font-size:.75rem;font-weight:400;color:var(--text-muted)">/hora</small></div></div>
          <div style="text-align:right"><div class="lmodal__price-note">Primeira consulta</div><div style="font-size:.88rem;font-weight:700;color:var(--green-600,#16a34a)">60€ (50% desconto)</div></div>
        </div>
        <div class="lmodal__section-title">Horários disponíveis</div>
        <div class="lmodal__slots">
  ...
  <div class="lmodal-overlay" id="m4">
    <div class="lmodal">
      ...
      <div class="lmodal__body">
        ...
        <div class="lmodal__info-grid">
          <div class="lmodal__info-item"><i class="fa-solid fa-location-dot"></i><div class="lmodal__info-text"><span class="lmodal__info-label">Localização</span><span class="lmodal__info-val">Coimbra, Portugal</span></div></div>
          <div class="lmodal__info-item"><i class="fa-solid fa-graduation-cap"></i><div class="lmodal__info-text"><span class="lmodal__info-label">Experiência</span><span class="lmodal__info-val">10 anos</span></div></div>
          <div class="lmodal__info-item"><i class="fa-solid fa-phone"></i><div class="lmodal__info-text"><span class="lmodal__info-label">Contacto</span><span class="lmodal__info-val">Telefone e Online</span></div></div>
          <div class="lmodal__info-item"><i class="fa-solid fa-house-chimney"></i><div class="lmodal__info-text"><span class="lmodal__info-label">Foco</span><span class="lmodal__info-val">Imobiliário</span></div></div>
        </div>
        <div class="lmodal__section-title">Sobre o advogado</div>
        ...
        <div class="lmodal__price-strip">
          <div><div class="lmodal__price-label">Valor da consulta</div><div class="lmodal__price-val">65€ <small style="font-size:.75rem;font-weight:400;color:var(--text-muted)">/hora</small></div></div>
          <div style="text-align:right"><div class="lmodal__price-note">Primeira consulta</div><div style="font-size:.88rem;font-weight:700;color:var(--green-600,#16a34a)">Gratuita</div></div>
        </div>
        <div class="lmodal__section-title">Horários disponíveis</div>
        <div class="lmodal__slots">
  ...
  <div class="lmodal-overlay" id="m5">
    <div class="lmodal">
      ...
      <div class="lmodal__body">
        ...
        <div class="lmodal__info-grid">
          <div class="lmodal__info-item"><i class="fa-solid fa-location-dot"></i><div class="lmodal__info-text"><span class="lmodal__info-label">Localização</span><span class="lmodal__info-val">Braga, Portugal</span></div></div>
          <div class="lmodal__info-item"><i class="fa-solid fa-graduation-cap"></i><div class="lmodal__info-text"><span class="lmodal__info-label">Experiência</span><span class="lmodal__info-val">18 anos</span></div></div>
          <div class="lmodal__info-item"><i class="fa-solid fa-building"></i><div class="lmodal__info-text"><span class="lmodal__info-label">Especialidade</span><span class="lmodal__info-val">Direito Empresarial</span></div></div>
          <div class="lmodal__info-item"><i class="fa-solid fa-video"></i><div class="lmodal__info-text"><span class="lmodal__info-label">Modalidade</span><span class="lmodal__info-val">Online e Presencial</span></div></div>
        </div>
        <div class="lmodal__section-title">Sobre a advogada</div>
        ...
        <div class="lmodal__price-strip">
          <div><div class="lmodal__price-label">Valor da consulta</div><div class="lmodal__price-val">100€ <small style="font-size:.75rem;font-weight:400;color:var(--text-muted)">/hora</small></div></div>
          <div style="text-align:right"><div class="lmodal__price-note">Primeira consulta</div><div style="font-size:.88rem;font-weight:700;color:var(--green-600,#16a34a)">50€ (50% desconto)</div></div>
        </div>
        <div class="lmodal__section-title">Horários disponíveis</div>
        <div class="lmodal__slots">
  ...
  <div class="lmodal-overlay" id="m6">
    <div class="lmodal">
      ...
      <div class="lmodal__body">
        ...
        <div class="lmodal__info-grid">
          <div class="lmodal__info-item"><i class="fa-solid fa-location-dot"></i><div class="lmodal__info-text"><span class="lmodal__info-label">Localização</span><span class="lmodal__info-val">Faro, Portugal</span></div></div>
          <div class="lmodal__info-item"><i class="fa-solid fa-graduation-cap"></i><div class="lmodal__info-text"><span class="lmodal__info-label">Experiência</span><span class="lmodal__info-val">6 anos</span></div></div>
          <div class="lmodal__info-item"><i class="fa-solid fa-heart"></i><div class="lmodal__info-text"><span class="lmodal__info-label">Abordagem</span><span class="lmodal__info-val">Humana e empática</span></div></div>
          <div class="lmodal__info-item"><i class="fa-solid fa-video"></i><div class="lmodal__info-text"><span class="lmodal__info-label">Modalidade</span><span class="lmodal__info-val">Online (todo o país)</span></div></div>
        </div>
        <div class="lmodal__section-title">Sobre o advogado</div>
        ...
        <div class="lmodal__price-strip">
          <div><div class="lmodal__price-label">Valor da consulta</div><div class="lmodal__price-val">60€ <small style="font-size:.75rem;font-weight:400;color:var(--text-muted)">/hora</small></div></div>
          <div style="text-align:right"><div class="lmodal__price-note">Primeira consulta</div><div style="font-size:.88rem;font-weight:700;color:var(--green-600,#16a34a)">Gratuita</div></div>
        </div>
        <div class="lmodal__section-title">Horários disponíveis</div>
        <div class="lmodal__slots">

...
<head>
  ...
  <title>Documentos · AngoLaw</title>
...
<body>
  ...
  <aside class="sidebar" id="sidebar">
    ...
    <nav class="sidebar__nav">
      ...
      <ul class="sidebar__menu">
        ...
        <li class="sidebar__menu-item sidebar__menu-item--active"><a href="documentos.html" class="sidebar__menu-link"><span class="sidebar__menu-icon"><i class="fa-solid fa-file-lines"></i></span><span class="sidebar__menu-text">Documentos</span></a></li>
    ...
    <header class="topbar">
      <div class="topbar__left">
        ...
        <div class="topbar__breadcrumb">
          <h1 class="topbar__title">Documentos</h1>
          <p class="topbar__subtitle">Modelos jurídicos prontos a usar e personalizar</p>
        </div>
      </div>
        ...
        <div class="doc-card">
          <div class="doc-card__top doc-card__top--blue">
            <div class="doc-card__file-icon">
              <i class="fa-solid fa-file-contract" style="font-size:2.2rem;color:var(--blue-500)"></i>
              <span class="doc-card__file-ext" style="color:var(--blue-600)">.docx</span>
            </div>
          </div>
          <div class="doc-card__body">
            <h3 class="doc-card__title">Contrato de Prestação de Serviços</h3>
            <p class="doc-card__desc">Modelo completo para formalizar a prestação de serviços entre empresas ou particulares. Inclui cláusulas de pagamento, prazos e responsabilidades.</p>
          </div>
          <div class="doc-card__footer">
            <span class="doc-card__meta"><i class="fa-regular fa-calendar" style="margin-right:4px"></i>Atualizado: Jan 2025</span>
            <button class="btn btn--navy btn--sm" data-modal-open="modal-prestacao">Usar Modelo</button>
          </div>
        </div>
  ...
  <div class="modal-overlay" id="modal-memorando">
    <div class="modal">
      <div class="modal__header"><h2 class="modal__title">Memorando Interno</h2><button class="modal__close" data-modal-close><i class="fa-solid fa-xmark"></i></button></div>
      <div class="modal__body"><div class="doc-modal-preview"><p><strong>MEMORANDO INTERNO</strong></p><p>Para: <strong>[DESTINATÁRIO]</strong> · De: <strong>[REMETENTE]</strong> · Data: <strong>[DATA]</strong></p><p>Assunto: [ASSUNTO DO MEMORANDO]</p></div><div class="doc-modal-fields"><div class="form-field"><label>Para (Destinatário)</label><input type="text" placeholder="Ex: Departamento Jurídico" /></div><div class="form-field"><label>Assunto</label><input type="text" placeholder="Ex: Atualização de Política Interna" /></div></div></div>
  ...
  <div class="modal-overlay" id="modal-procuracao">
    <div class="modal">
      <div class="modal__header"><h2 class="modal__title">Procuração</h2><button class="modal__close" data-modal-close><i class="fa-solid fa-xmark"></i></button></div>
      <div class="modal__body"><div class="doc-modal-preview"><p><strong>PROCURAÇÃO</strong></p><p>Eu, <strong>[MANDANTE]</strong>, pelo presente instrumento, constituo meu(minha) bastante procurador(a) <strong>[MANDATÁRIO]</strong>...</p></div><div class="doc-modal-fields"><div class="form-field"><label>Nome do Mandante</label><input type="text" placeholder="Quem delega os poderes" /></div><div class="form-field"><label>Nome do Mandatário</label><input type="text" placeholder="Quem recebe os poderes" /></div><div class="form-field"><label>Tipo de Procuração</label><select><option>Geral</option><option>Especial</option><option>Irrevogável</option></select></div></div></div>
      <div class="modal__footer"><button class="btn btn--outline" data-modal-close>Cancelar</button><button class="btn btn--primary"><i class="fa-solid fa-download" style="margin-right:6px"></i>Descarregar Modelo</button></div>
    </div>
  </div>
  ...
  <div class="modal-overlay" id="modal-arrendamento">
    <div class="modal">
      <div class="modal__header"><h2 class="modal__title">Contrato de Arrendamento</h2><button class="modal__close" data-modal-close><i class="fa-solid fa-xmark"></i></button></div>
      <div class="modal__body"><div class="doc-modal-preview"><p><strong>CONTRATO DE ARRENDAMENTO URBANO</strong></p><p>O(A) <strong>[SENHORIO]</strong> dá de arrendamento ao(à) <strong>[INQUILINO]</strong> o imóvel sito em <strong>[MORADA]</strong>, pelo prazo de <strong>[PRAZO]</strong>...</p></div><div class="doc-modal-fields"><div class="form-field"><label>Nome do Senhorio</label><input type="text" placeholder="Nome completo" /></div><div class="form-field"><label>Nome do Inquilino</label><input type="text" placeholder="Nome completo" /></div><div class="form-field"><label>Valor da Renda (€/mês)</label><input type="number" placeholder="Ex: 750" /></div><div class="form-field"><label>Início do Arrendamento</label><input type="date" /></div></div></div>
      <div class="modal__footer"><button class="btn btn--outline" data-modal-close>Cancelar</button><button class="btn btn--primary"><i class="fa-solid fa-download" style="margin-right:6px"></i>Descarregar Modelo</button></div>
    </div>
  </div>
  ...
  <div class="modal-overlay" id="modal-termo">
    <div class="modal">
      <div class="modal__header"><h2 class="modal__title">Termo de Responsabilidade</h2><button class="modal__close" data-modal-close><i class="fa-solid fa-xmark"></i></button></div>
      <div class="modal__body"><div class="doc-modal-preview"><p><strong>TERMO DE RESPONSABILIDADE</strong></p><p>Eu, <strong>[NOME]</strong>, portador(a) do CC nº <strong>[CC]</strong>, declaro assumir total responsabilidade por <strong>[OBJETO]</strong>...</p></div><div class="doc-modal-fields"><div class="form-field"><label>Nome do Declarante</label><input type="text" placeholder="Nome completo" /></div><div class="form-field"><label>Objeto da Responsabilidade</label><input type="text" placeholder="Ex: utilização do veículo X" /></div></div></div>
      <div class="modal__footer"><button class="btn btn--outline" data-modal-close>Cancelar</button><button class="btn btn--primary"><i class="fa-solid fa-download" style="margin-right:6px"></i>Descarregar Modelo</button></div>
    </div>
  </div>
